    ...
    public function run()
    {
        ...
        foreach($fkeys as $fkey) {
            $projects[] = [
                ...
                'year' => rand(2000,2024),
                'college_unit' => rand(1,10),
                'main_status' => rand(1,5),
                'project_in_charge' => 'Person ' . $counter,
                'notice_of_award' => date("Y-m-d",rand(329447722,1717982122)),
                'notice_to_proceed' => date("Y-m-d",rand(329447722,1717982122)),
                ...
                'original_date_of_completion' => date("Y-m-d",rand(329447722,1717982122)),
                'remaining_number_of_days' => rand(5,99),
                'created_by' => 1,
            ];
            $counter+=1;
        }
